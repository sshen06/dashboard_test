...
# ──────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description='LoRa GPS Telemetry Dashboard (DEMO ONLY)')
    parser.add_argument('--host', default='0.0.0.0')
    parser.add_argument('--web-port', default=8080, type=int, dest='web_port')
    args = parser.parse_args()

    print("[DEMO] Running FAKE LoRa data (no hardware required)")
